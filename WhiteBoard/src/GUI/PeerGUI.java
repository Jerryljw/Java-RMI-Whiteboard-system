...
public class PeerGUI implements IClient, MouseListener, MouseMotionListener, ActionListener, WindowListener {
    ...
    public PeerGUI(IWhiteBoard whiteBoard, String username) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (message != null) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(peerFrame, "Remote error occur...");
                    }
                } else {
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if (shapeDrawing.equals("pen") || shapeDrawing.equals("eraser")) {
            ...
            String texts = JOptionPane.showInputDialog(peerFrame, "input your text", "text",
    ...
    public void windowClosing(WindowEvent e) {
        try {
            iWhiteBoard.peerExit(this.username);
        } catch (RemoteException remoteException) {
            JOptionPane.showMessageDialog(peerFrame, "Remote error occur...");
        } finally {
            e.getWindow().dispose();
